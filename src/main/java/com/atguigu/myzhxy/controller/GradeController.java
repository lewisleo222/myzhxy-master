...
public class GradeController {
    ...
    @ApiOperation("根据年龄名称模糊查询,带分页")
    @GetMapping("/getGrades/{pageNo}/{pageSize}")
    public Result getGrades(@ApiParam("分页查找的页码数") @PathVariable("pageNo") Integer pageNo,
                            @ApiParam("分页查询的页大小") @PathVariable("pageSize") Integer pageSize,
                            @ApiParam("分页查找模糊匹配的名称") String gradeName){
        //分页 带条件查询
    ...
    @ApiOperation("新增或者修改grade,有id属性是修改,没有测试新增")
